...
public class Schema {
	 ...
	 * 
	 * @param fname name for the column
	 * @param max_size maximum length of characters for the varchar column
	 */
	 ...
	 * 
	 * @param fname the name of the field (column)
	 */
	 ...
	 * 
	 * @param i the field (column) to return the type for
	 */
	 ...
	 * 
	 * @param i the column to get the name of
	 */
	 ...
	 * key.
	 * 
	 * @param s the schema for the resulting joined tables
	 */
	 ...
	 * ByteBuffer.
	 * 
	 * @param byte_buffer the buffer of bytes to deserialize the schema from
	 */
